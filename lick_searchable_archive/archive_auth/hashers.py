...
class APR_MD5PasswordHasher(BasePasswordHasher):
    ...
    def salt(self):
        ...
        # Return salt 8 characters long, to prevent failures since this algorithm only suppo
        return get_random_string(8, RANDOM_STRING_CHARS)
    ...
    def encode(self, password, salt):
        ...
        return ctx.hash(password,salt=salt)

    def verify(self, password, encoded):
        """Verify if a password matches a given encoded hash."""
        ctx = CryptContext(self.passlib_algorithm)
        return ctx.verify(password, encoded)
    ...
    def safe_summary(self, encoded):
        ...
        assert split_hash[0] == "" and split_hash[1] == "apr1"
